...
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="cms-menu-items {{ request()->routeIs('admin.cms.*') && !request()->routeIs('admin.cms.footer*') && !request()->routeIs('admin.cms.seo*') ? 'show' : '' }}">
            ...
            <div class="settings-menu-items {{ request()->routeIs('admin.cms.footer*') || request()->routeIs('admin.cms.seo*') ? 'show' : '' }}">
